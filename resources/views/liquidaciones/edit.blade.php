...
<div class="container mx-auto max-w-4xl bg-white shadow-md rounded-lg p-8">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Nueva Liquidación</h1>
        ...
        <div class="grid md:grid-cols-2 gap-6 mb-10">
            ...
            <div class="space-y-4">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" name="modalidad_calculo" value="opcion1" {{ $liquidacion->modalidad_calculo == 'opcion1' ? 'checked' : '' }}> 
                        Opción 1: Peso Neto * (1-Descuento) - Tiki/Buche
                    </div>
                    <div>
                        <input type="radio" name="modalidad_calculo" value="opcion2" {{ $liquidacion->modalidad_calculo == 'opcion2' ? 'checked' : '' }}> 
        ...
        <script>
            ...
            let tablaMostrada = {{ count($descuentos) > 0 ? 'true' : 'false' }};
            let indexGuardado = {{ count($descuentos) }}; 
